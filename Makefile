#############################################################################
# Makefile for building: mlp.app/Contents/MacOS/mlp
# Generated by qmake (3.1) (Qt 6.4.0)
# Project:  mlp.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile mlp.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = mlp1.0.0
DISTDIR = /Users/anastasiadementeva/Desktop/mlp/.tmp/mlp1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.3.sdk -mmacosx-version-min=13.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/opt/homebrew/lib
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/macx.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/sanitize.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/gcc-base.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/gcc-base-mac.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/clang.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/clang-mac.conf \
...
EXPORT__PRO_FILE_ = /Users/anastasiadementeva/Desktop/mlp/mlp.pro


include /opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules
...
Makefile: mlp.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.4.0/share/qt/mkspecs/common/macx.conf \
...
mlp.app/Contents/PkgInfo: 
	@test -d mlp.app/Contents || mkdir -p mlp.app/Contents
	@$(DEL_FILE) mlp.app/Contents/PkgInfo
	@echo "APPL????" > mlp.app/Contents/PkgInfo
mlp.app/Contents/Resources/empty.lproj: 
	@test -d mlp.app/Contents/Resources || mkdir -p mlp.app/Contents/Resources
	@touch mlp.app/Contents/Resources/empty.lproj
	
mlp.app/Contents/Info.plist: 
	@test -d mlp.app/Contents || mkdir -p mlp.app/Contents
	@$(DEL_FILE) mlp.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,a.mlp,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},a.mlp,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,mlp,g" -e "s,@LIBRARY@,mlp,g" -e "s,\$${EXECUTABLE_NAME},mlp,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app >mlp.app/Contents/Info.plist

all: Makefile \
		mlp.app/Contents/PkgInfo \
		mlp.app/Contents/Resources/empty.lproj \
		mlp.app/Contents/Info.plist mlp.app/Contents/MacOS/mlp
...
main.o: main.cpp /opt/homebrew/lib/QtWidgets.framework/Headers/QHBoxLayout \
